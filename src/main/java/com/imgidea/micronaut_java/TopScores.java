...
public class TopScores {
    ...
    @Post("/top-score")
    public HttpResponse topScore(HttpRequest request, @Body String jsonBody) {
        ...
        try {
            ...
            e.printStackTrace();
            JsonError error = new JsonError("UnprocessableEntity").link(Link.SELF, Link.of(request.getUri()));
            return HttpResponse.<JsonError>unprocessableEntity().body(error);
        }
        ...
        return HttpResponse.ok().body(jsonBody);
    }
}
